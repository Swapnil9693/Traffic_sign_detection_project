...
path1 = 'C:/100%traffic_sign_detection/test/6'    #path of folder of images    
path2 = 'C:/100%traffic_sign_detection/test/6'  #path of folder to save images    
...
# =============================================================================
#  immatrix = np.array([array(Image.open('input_data_resized/'+ im2)).flatten()
#                       for im2 in imlist],'f')
#                
